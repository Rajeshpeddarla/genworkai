...
export const baseparsePricingPlans = pgTable('baseparse_pricing_plans', {
  ...
  priceInrPaise: integer('price_inr_paise').notNull().default(0),
  discountUsdCents: integer('discount_usd_cents').default(0),
  discountInrPaise: integer('discount_inr_paise').default(0),
  ...
  cashfreePlanId: varchar('cashfree_plan_id', { length: 255 }),
  isActive: boolean('is_active').default(true),
