...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-[#020202] flex flex-col md:flex-row font-sans">
      ...
      <div className="hidden md:flex md:w-1/2 lg:w-5/12 bg-zinc-950 border-r border-white/10 relative overflow-hidden flex-col justify-between p-12">
        ...
        >
          ...
          <div className="bg-white/5 border border-white/10 rounded-3xl p-8 sm:p-10 shadow-2xl backdrop-blur-xl max-h-[85vh] overflow-y-auto custom-scrollbar">
            ...
            <button 
              ...
              className="w-full mt-8 bg-zinc-900 border border-white/10 hover:bg-zinc-800 text-white py-3 rounded-xl font-medium flex items-center justify-center gap-3 transition-colors"
            >
