          ...
          <div className="bg-white/5 border border-white/10 rounded-3xl p-8 sm:p-10 shadow-2xl backdrop-blur-xl max-h-[85vh] overflow-y-auto custom-scrollbar">
            ...
            <div className="grid grid-cols-2 gap-4 mt-8">
              <button 
                ...
                className="w-full bg-card border border-white/10 hover:bg-zinc-800 text-white py-3 rounded-xl font-medium flex items-center justify-center gap-3 transition-colors"
              >
